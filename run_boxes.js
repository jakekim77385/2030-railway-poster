...
const newBoxes = `<div style="display: flex; gap: 15px;">
                  <!-- Box 1 -->
...
let startIdx = lines.findIndex(l => l.includes('class="industrial-diagram"'));
if (startIdx !== -1) {
  let endIdx = -1;
  ...
  if (endIdx !== -1) {
    ...
    console.log('Successfully replaced inner diagram boxes');
  } else {
